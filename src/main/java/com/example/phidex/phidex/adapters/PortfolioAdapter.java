...
public class PortfolioAdapter extends RecyclerView.Adapter<PortfolioAdapter.ViewHolders> {

    private Context mContext;
    List<Coin> coins;
    private static AppDatabase ad;
    private static PortfolioActivity portfolioActivity;
    Resources res;
    public static float coinHolding;

    public PortfolioAdapter(List<Coin> coins, AppDatabase ad, PortfolioActivity pa, Context context) {
        this.mContext = context;
        this.coins = coins;
        this.ad = ad;
        this.portfolioActivity = pa;
        this.res = context.getResources();
    }

    @Override
    public PortfolioAdapter.ViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.portfolio_coin_row, parent, false);
        return new ViewHolders(view);
    }

    @Override
    public void onBindViewHolder(final PortfolioAdapter.ViewHolders holder, int position) {
            ...
            public boolean onLongClick(View view) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        ad.transactionDao().deleteTransactionsFromCoinId(thisCoin.getCoinId());
                        Toast.makeText(mContext, "Coin deleted.", Toast.LENGTH_SHORT).show();
                        portfolioActivity.updateActivity();
                        return true;
                    }
                });
                popup.show();
